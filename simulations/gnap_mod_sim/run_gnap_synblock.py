...
def main(prefix, run_seed, g_nap_str, idx, hyp_opioid, syn_shut, struct, condition):
    ...
    os.mkdir(f'synblock_output_plots/{struct}_figs/{prefix}')
    basename='test'
    ...
    plt.axis('equal')
    plt.tight_layout()
    plt.savefig(f'synblock_output_plots/{struct}_figs/{prefix}/{prefix}_gnap_gleak.png')
    ...
    sns.despine()
    plt.savefig(f'synblock_output_plots/{struct}_figs/{prefix}/{prefix}_gnap_pert.png')
...
#     net.run(20*second,report='text')
    ...
    plt.savefig(f'synblock_output_plots/{struct}_figs/{prefix}/{prefix}_gnap_trace.png')
